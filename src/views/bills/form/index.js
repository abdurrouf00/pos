...
export default function BillsForm() {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.vendorName || !formData.billNo || !formData.billDate) {
    ...
    const existingBills = JSON.parse(localStorage.getItem("submittedBills") || "[]");
    const updatedBills = [...existingBills, billToSave];
    localStorage.setItem("submittedBills", JSON.stringify(updatedBills));
