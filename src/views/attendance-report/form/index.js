...
const AttendanceReportForm = (props) => {
  ...
  const { basicAttendanceReportData } = useSelector(
    ...
    const loadAllData = async () => {
      ...
      try {
        await Promise.all([
          ...
          dispatch(getAllEmployee(employeeParams)),
        ]);
      } finally {
  ...
  const handleSubmit = () => {
    switch (report_type) {
      case "1":
        ...
        router.push(`/dashboard/attendance-report/details?report_type=1&date=${date}&department=${department}`);
        break;
      case "2":


        router.push(`/dashboard/attendance-report/details?report_type=2&year=${year}&month=${month}`);
        break;
      case "3":
        const data = {
          from_date: from_date,
        ...
        router.push(`/dashboard/attendance-report/details?report_type=3&from_date=${from_date}&to_date=${to_date}&employee_id=${employee}`);
        break;
      case "4":
        ...
        router.push(`/dashboard/attendance-report/details?report_type=4&from_date=${from_date}&to_date=${to_date}&employee_id=${employee}`);
        break;
      case "5": {
        const data = {
          from_date: from_date,
        ...
        router.push(`/dashboard/attendance-report/details?report_type=5&from_date=${from_date}&to_date=${to_date}`);
