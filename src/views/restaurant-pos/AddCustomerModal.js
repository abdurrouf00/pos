      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div 
            ...
            className="bg-white w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden flex flex-col relative z-10"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Modal Header */}
            <div className="px-6 py-4 border-b border-[#109df9]/10 flex items-center justify-between bg-[#109df9] sticky top-0 z-10">
              <h2 className="text-xl font-bold text-white">Add Customer Details</h2>
              <button 
                onClick={onClose}
              ...
              <form onSubmit={handleSave} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex flex-col gap-1.5 md:col-span-2">
                  ...
                  <textarea 
                    ...
                    onChange={handleChange}
                    rows="3"
                    className="p-2.5 bg-gray-50 border border-gray-300 rounded-lg focus:ring-[#109df9] focus:border-[#109df9] outline-none text-sm transition-all resize-none" 
                  />
                </div>

                {/* Modal Actions */}
                <div className="flex items-center justify-end gap-3 mt-6 md:col-span-2">
                  <button 
                    type="button"
                    onClick={onClose}
