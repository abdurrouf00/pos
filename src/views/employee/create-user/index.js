...
import { bindEmployeeData, bindSingleEmployeeData, createUser, getAllEmployee, getSingleEmployee, initialemployeeData } from '../store';
...
export default function CreateUser({ open, setOpen, empId, params }) {
  ...
  return (
    <Modal open={open} onOpenChange={setOpen}>
      <ModalContent>
        <ModalTitle>Create User {singleEmployeeData?.name && `(${singleEmployeeData?.name})`}</ModalTitle>
