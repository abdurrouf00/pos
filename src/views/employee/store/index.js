...
export const employeeSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(getSingleEmployee.fulfilled, (state, action) => {
      const { devision, id, department, created_at, updated_at, organization_id, project_id, deleted_at, serial, serial_number, previous_company, joinning_designation, pay_scale, job_type, division, section, category_id, category, designation, payment_type, branch_id, ...data } = action.payload;
      ...
      const { company_name = [], position = [], joining_date = [], resign_date = [] } = data.prev_job_info;
      ...
      state.basicEmployeeData = {
        ...
        job_type_id: data.job_type_id ?? '',
        pay_scale_id: data.pay_scale_id ?? '',
        prev_job_info: !Array.isArray(data.prev_job_info) ? Array.from({ length: prev_job_info_length }, (_, index) => {
          return {
        ...
        edu_info: !Array.isArray(data.edu_info) ? Array.from({ length: edu_info_length }, (_, index) => ({
          degree: degree[index] ?? "",
