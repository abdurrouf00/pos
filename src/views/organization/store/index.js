...
const organizationApi = 'settings/organization'
...
export const updateOrganization = createAsyncThunk(
  ...
  async data => {
    const { id, ...rest } = data
    const result = axios
      .post(`${organizationApi}`, { ...rest, _method: 'PUT' })
      .then(res => {
        return res
      })
      .catch(err => console.log(err))
