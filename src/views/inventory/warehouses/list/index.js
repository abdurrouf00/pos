...
import { useDeletewarehouseMutation, useGetwarehousesQuery } from '../store'
...
export default function WarehouseList() {
  ...
  const [deleteTaxRate] = useDeletewarehouseMutation()
  ...
  return (
    <div className="bg-white p-4 rounded-md">
      <DataTable
        data={data?.data?.data}
        columns={getWarehouseColumns(handleEdit, handleDelete)}
