      ...
      <table className="w-full border-collapse border border-gray-300 text-sm">
        <thead className="bg-gray-200">
          <tr>
            ...
            <th className="p-2 text-left">Appointment For</th>
            <th className="p-2 text-left"> Service Name</th>
            <th className="p-2 text-left">Appointment Start Time</th>
        ...
        <tbody>
          {leads.map((lead, index) => (
            <tr key={index} className="border-b hover:bg-gray-100">
              ...
              <td className="p-2">{lead.for}</td>
              <td className="p-2">{lead.service}</td>
              <td className="p-2">{lead.from}</td>
