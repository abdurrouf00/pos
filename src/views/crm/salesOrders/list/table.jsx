...
import leadsData from "@/tableData.json";
  ...
  return (
    <div className="p-4 pt-15">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold">Sales Order Table</h2>
      ...
      <table className="w-full border-collapse border border-gray-300 text-sm">
        <thead className="bg-gray-200">
          <tr>
            ...
            <th className="p-2 text-left">Quote Stage</th>         
            ...
            <th className="p-2 text-left"> Quote Owner</th>
        ...
        <tbody>
          {leads.map((lead, index) => (
            <tr key={index} className="border-b hover:bg-gray-100">
              ...
              <td className="p-2">{lead.subject}</td>
              <td className="p-2">{lead.status}</td>
              <td className="p-2">{lead.total}</td>
              <td className="p-2">{lead.dealName}</td>
              <td className="p-2">{lead.contact}</td>              
              <td className="p-2">{lead.account}</td>             
