...
import { addBranch, bindBranchData, getAllBranches, getBranchById, initialBranchData, updateBranch } from "../store";
...
const BranchForm = (props) => {
  ...
  const { id, name, phone, email, address, l_b_a, location_attributes, has_multiple_shift, shift_time_range, device_key, device_url, device_type, device_company, company_id } = basicBranchData;
